      ...
      >
        <div className="relative m-auto h-full max-w-7xl">
          <Dialog
            ref={ref}
            className={cn(
              'style-focus enter:scale-100 absolute top-0 flex max-h-full w-full max-w-lg flex-initial scale-0 flex-col rounded-md bg-white pt-6 pb-0 outline-none drop-shadow-lg transition-transform duration-300',
