...
import { Calendar, Cross, SettingsHorizontal } from 'akar-icons';
  ...
  return (
    <>
      <div className="m-auto flex max-w-7xl justify-between">
        <DialogDisclosure className="style-btn bg-white px-3 text-cyan-700 outline-none transition-colors hover:bg-cyan-300">
          {translation?.date}
